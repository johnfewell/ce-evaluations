...
ActiveRecord::Schema.define(version: 2018_09_18_203936) do
  ...
  add_foreign_key "answers", "attendees"
  add_foreign_key "answers", "questions"
  add_foreign_key "finished_evaluations", "attendees"
  add_foreign_key "finished_evaluations", "courses"
  add_foreign_key "finished_evaluations", "evaluations"
